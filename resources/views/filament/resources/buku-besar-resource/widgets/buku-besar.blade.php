                ...
                <form wire:submit.prevent="filterJurnal" class="flex gap-4 items-center">
                    ...
                    <div>
                        ...
                        <select wire:model="coa_id" id="coa_id" class="border rounded px-2 py-1">
                            ...
                            @foreach (\App\Models\AkunCoa::all() as $akun)
            ...
            <table class="w-full text-sm text-left border border-gray-200 font-sans">
                <thead class="bg-gray-100 text-xs uppercase">
                    <tr class="font-semibold bg-gray-200">
                        ...
                        <td colspan="2" class="text-right px-4 py-2 border">Rp {{ number_format($saldoAwal, 0, ',', '.') }}</td>
                    </tr>
                    <tr>
                ...
                <tfoot class="font-semibold text-xs bg-gray-200">
                    ...
                    <tr class="font-semibold bg-gray-100">
                        ...
                        <td class="text-right px-4 py-2 border">Rp {{ number_format($totalDebit, 0, ',', '.') }}</td>
                        <td class="text-right px-4 py-2 border">Rp {{ number_format($totalKredit, 0, ',', '.') }}</td>
                    </tr>
                    <tr class="font-semibold bg-gray-200">
                        <td colspan="4" class="text-right px-4 py-2 border">Saldo Akhir</td>
                        <td colspan="2" class="text-right px-4 py-2 border">Rp {{ number_format($saldoAkhir, 0, ',', '.') }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
